...
import com.test.pokemon.presentation.viewmodel.RegisterUiState
    ...
    Box(
        ...
        Column(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Text(
                    text = "Mulai koleksi Pokémon favoritmu dan simpan di aplikasi.",
            ...
            ElevatedCard(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    Button(
                        ...
                        Text(if (uiState.isLoading) "Mendaftarkan..." else "Daftar Sekarang")
                    }
                    OutlinedButton(
